  ...
  factory App.fromJson(Map<String, dynamic> json) {
    ...
    try {
      return App(
        ...
        allowIdChange: (json['allowIdChange'] ?? false) as bool,
...
abstract class AppSource {
  ...
  List<List<GeneratedFormItem>> get _commonAppSettingFormItems => [
    ...
    [GeneratedFormSwitch('allowInsecure', label: tr('allowInsecure'))],
    [
      GeneratedFormSwitch(
  ...
  List<List<GeneratedFormItem>> get combinedAppSpecificSettingFormItems {
    ...
    if (allowIncludeZips) {
      moreConditionalItems.addAll([
        [GeneratedFormSwitch('includeZips', label: tr('includeZips'))],
        [
          GeneratedFormTextField(
    ...
    if (allowIncludeTarballs) {
      moreConditionalItems.addAll([
        [GeneratedFormSwitch('includeTarballs', label: tr('includeTarballs'))],
        [
          GeneratedFormTextField(
...
void _migrateAdditionalDataToSettings(
  ...
  final decoded = jsonDecode(json['additionalData'] as String);
...
void _migrateApkUrlsFormat(Map<String, dynamic> json) {
  ...
  try {
    apkUrls = getApkUrlsFromUrls(
      List<String>.from(apkUrlJson as List<dynamic>),
    );
  } catch (e) {
    apkUrls = assumed2DlistToStringMapList(
      List<dynamic>.from(apkUrlJson as List<dynamic>),
    );
  }
...
Map<String, dynamic> _migrateHtmlSpecificMigrations(
  ...
  final intermediateLinks = additionalSettings['intermediateLink'];
  if (intermediateLinks is List && intermediateLinks.isNotEmpty) {
    additionalSettings['intermediateLink'] = intermediateLinks.where((
      dynamic e,
    ) {
      return e is Map &&
          e['customLinkFilterRegex']?.toString().isNotEmpty == true;
    }).toList();
  }
...
Map<String, dynamic> appJSONCompatibilityModifiers(Map<String, dynamic> json) {
  ...
  if (json['additionalSettings'] != null) {
    originalAdditionalSettings = Map<String, dynamic>.from(
      jsonDecode(json['additionalSettings'] as String) as Map<dynamic, dynamic>,
    );
