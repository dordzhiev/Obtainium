    ...
    switch (type) {
      case GeneratedFormItemType.textField:
        return GeneratedFormTextField(
          ...
          additionalValidators: List<String? Function(String?)>.from(
            validators,
          ),
          required: required,
          max: max,
      ...
      case GeneratedFormItemType.switch_:
        return GeneratedFormSwitch(
          ...
          label: label,
          belowWidgets: belowWidgets,
          value: (defaultValue ?? false) as bool,
          disabled: disabledSwitch,
          additionalValidators: List<String? Function(bool)>.from(validators),
        );
  ...
  GeneratedFormDropdown clone() {
    return GeneratedFormDropdown(
      ...
      disabledOptKeys: disabledOptKeys != null
          ? List<String>.from(disabledOptKeys!)
          : null,
      required: required,
      helpUrl: helpUrl,
      additionalValidators: List<String? Function(String?)>.from(
...
class GeneratedFormSwitch extends GeneratedFormItem {
  ...
  GeneratedFormSwitch clone() {
    return GeneratedFormSwitch(
      ...
      value: value as bool,
      disabled: disabled,
      additionalValidators: List<String? Function(bool)>.from(
        additionalValidators,
      ),
    );
  }
  ...
  for (final row in items) {
    for (final el in row) {
      if (el is GeneratedFormSwitch) {
        ...
        entries.add(MapEntry(el.key, el.value ?? <dynamic>[]));
      } else {
