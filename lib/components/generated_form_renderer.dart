...
class _GeneratedFormState extends State<GeneratedForm> {
  ...
  final List<GlobalKey<FormFieldState<dynamic>>> _fieldKeys = [];
  ...
  InputDecoration _fieldDecoration({
    ...
    return InputDecoration(
      ...
      suffixIconConstraints: widget.tileMode ? const BoxConstraints() : null,
    );
  }
        ...
        final textField = TextFormField(
          ...
          validator: (value) {
            ...
            for (var validator in formItem.additionalValidators) {
              final String? result = (validator as String? Function(String?))(
                value,
              );
              if (result != null) {
                return '$result\n';
  ...
  Widget _buildSubForm(
    ...
    final valuesForField = values[fieldKey] as List<dynamic>;
    final int n = valuesForField.length;
                ...
                child: Row(
                  children: [
                    IconButton(
                      ...
                      onPressed: n > 0
                          ? () {
                              final temp = List<dynamic>.from(valuesForField);
                              temp.removeAt(i);
